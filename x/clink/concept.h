#ifndef cf_x_clink_concept_h
#define cf_x_clink_concept_h

#include "cf/x/core/object.h"

struct cf_x_clink_concept_t;
typedef struct cf_x_clink_concept_t cf_x_clink_concept_t;

cf_x_clink_concept_t *cf_x_clink_concept_create(void *concept,
