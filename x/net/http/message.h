#ifndef cf_x_net_http_message_h
#define cf_x_net_http_message_h
...
#define CF_X_NET_HTTP_MESSAGE_NO_HEADERS NULL
#define CF_X_NET_HTTP_MESSAGE_NO_RESOURCE_PATH NULL
...
typedef struct cf_x_net_http_message_t cf_x_net_http_message_t;
...
cf_x_net_engine_id_t cf_x_net_http_message_get_engine_id(void *message_object);
