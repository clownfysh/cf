#ifndef cf_x_net_star_client_conf_h
#define cf_x_net_star_client_conf_h

#include "cf/x/config/file.h"

struct cf_x_net_star_client_conf_t {
...
typedef struct cf_x_net_star_client_conf_t cf_x_net_star_client_conf_t;
