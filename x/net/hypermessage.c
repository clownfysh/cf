...
static cf_x_core_bool_t cf_x_net_hypermessage_create_pri
(cf_x_net_hypermessage_t *hypermessage);

static void cf_x_net_hypermessage_create_rollback
(cf_x_net_hypermessage_t *hypermessage);
    ...
    cf_x_case_set_t *hyperheaders)
{
  ...
  if (so_far_so_good) {
    if (hypermessage->resource_path) {
      if (!cf_x_net_hypermessage_create_pri(hypermessage)) {
        so_far_so_good = cf_x_core_bool_false;
      }
    }
  }
  ...
  if (!so_far_so_good && hypermessage) {
    cf_x_net_hypermessage_create_rollback(hypermessage);
    hypermessage = NULL;
  }
...
cf_x_core_bool_t cf_x_net_hypermessage_create_pri(cf_x_net_hypermessage_t *hypermessage)
{
...
void cf_x_net_hypermessage_create_rollback(cf_x_net_hypermessage_t *hypermessage)
{
  assert(hypermessage);
...
cf_x_net_engine_id_t cf_x_net_hypermessage_get_engine_id
(void *message_object)
{
...
(cf_x_net_hypermessage_t *hypermessage, char *parameter_name)
{
  ...
  value_string
    = cf_x_net_hypermessage_get_pri_parameter(hypermessage, parameter_name);
  if (value_string) {
    ...
    cf_x_core_content_t content_type, char *body, unsigned long body_size)
{
  ...
  if (!cf_x_net_hypermessage_set_hyperheader
