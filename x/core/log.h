#ifndef cf_x_core_log_h
#define cf_x_core_log_h

#include "cf/x/core/bool.h"
#include "cf/x/core/tools.h"

#define cf_x_core_log_trace(log, system, entry, ...) _x_audit_log_trace \
  (log, system, entry, __FILE__, __LINE__, ##__VA_ARGS__);

#define cf_x_core_log_trace_exit(log, system, entry, ...) _x_audit_log_trace \
  (log, system, entry, __FILE__, __LINE__, ##__VA_ARGS__); exit(44);

struct cf_x_core_log_t;
typedef struct cf_x_core_log_t cf_x_core_log_t;
