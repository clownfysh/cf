#ifndef cf_x_core_int_h
#define cf_x_core_int_h

#include "cf/x/core/object.h"
#include "cf/x/core/objectey.h"

struct cf_x_core_int_t;
typedef struct cf_x_core_int_t cf_x_core_int_t;

int cf_x_core_int_compare(void *int_object_a, void *int_object_b);
