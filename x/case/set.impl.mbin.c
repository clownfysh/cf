...
#include "x/case/mbin.h"

x_core_bool_t x_case_set_add(x_case_set_t *set, void *object)
{
  return x_case_mbin_add((x_case_mbin_t *) set, object);
}
...
{
  return (x_case_set_t *) x_case_mbin_create(objectey,
      X_CASE_MBIN_SET_TYPE_SET);
}

void x_case_set_destroy(void *set_object)
{
  x_case_mbin_destroy(set_object);
}

void *x_case_set_find(x_case_set_t *set, void *decoy_object)
{
  return x_case_mbin_find((x_case_mbin_t *) set, decoy_object);
}
...
{
  return x_case_mbin_get_objectey((x_case_mbin_t *) set);
}

unsigned long x_case_set_get_size(x_case_set_t *set)
{
  return x_case_mbin_get_size((x_case_mbin_t *) set);
}

void *x_case_set_iterate_next(x_case_set_t *set)
{
  return x_case_mbin_iterate_next((x_case_mbin_t *) set);
}

void x_case_set_iterate_remove(x_case_set_t *set)
{
  x_case_mbin_iterate_remove((x_case_mbin_t *) set);
}

void x_case_set_iterate_start(x_case_set_t *set)
{
  x_case_mbin_iterate_start((x_case_mbin_t *) set);
}
...
{
  x_case_mbin_remove((x_case_mbin_t *) set, object);
