...
{
  return cf_x_case_mbin_add((cf_x_case_mbin_t *) set, object);
}
...
{
  cf_x_case_mbin_destroy(set_object);
}

void *cf_x_case_set_find(cf_x_case_set_t *set, void *decoy_object)
{
  return cf_x_case_mbin_find((cf_x_case_mbin_t *) set, decoy_object);
}
...
{
  return cf_x_case_mbin_get_size((cf_x_case_mbin_t *) set);
}

void *cf_x_case_set_iterate_next(cf_x_case_set_t *set)
{
  return cf_x_case_mbin_iterate_next((cf_x_case_mbin_t *) set);
}

void cf_x_case_set_iterate_remove(cf_x_case_set_t *set)
{
  cf_x_case_mbin_iterate_remove((cf_x_case_mbin_t *) set);
}

void cf_x_case_set_iterate_start(cf_x_case_set_t *set)
{
  cf_x_case_mbin_iterate_start((cf_x_case_mbin_t *) set);
}
...
{
  cf_x_case_mbin_remove((cf_x_case_mbin_t *) set, object);
