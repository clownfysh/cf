#ifndef cf_x_case_xcache_item_h
#define cf_x_case_xcache_item_h

#include "cf/x/core/object.h"
#include "cf/x/core/uuid.h"

struct cf_x_case_xcache_item_t;
typedef struct cf_x_case_xcache_item_t cf_x_case_xcache_item_t;

int cf_x_case_xcache_item_compare(void *item_object_a, void *item_object_b);
