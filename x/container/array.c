...
x_core_bool_t add_to_message(x_container_array_t *array,
...
int x_container_array_compare(void *array_object_a,
    void *array_object_b)
{
  assert(array_object_a);
  assert(array_object_b);
  x_container_array_t *array_a;
  x_container_array_t *array_b;
  int compare_result;
  void *object_a;
  void *object_b;
  unsigned long array_size;
...
void *x_container_array_copy(void *array_object)
{
  ...
  x_container_array_t *array_copy;
  unsigned long index;
  void *object;
  void *object_copy;
  ...
  array_copy = x_container_array_create(array->array_size,
  ...
  if (array_copy) {
    for (index = 0; index < array->array_size; index++) {
      ...
      if (object) {
        ...
        x_container_array_add(array_copy, index, object_copy);
      }
    }
  }
...
(char *string, char *separators)
{
  ...
  array = x_container_array_create(field_count, x_core_string_compare,
  ...
  if (array) {
    ...
    while (token) {
      ...
      if (token_copy) {
        x_container_array_add(array, index, token_copy);
        index++;
      } else {
...
x_core_compare_f x_container_array_get_compare
(x_container_array_t *array)
{
  return array->compare;
}

x_core_copy_f x_container_array_get_copy
(x_container_array_t *array)
{
  return array->copy;
}

x_core_destroy_f x_container_array_get_destroy
(x_container_array_t *array)
{
  ...
  if (array->iterator < array->array_size) {
    if (array->iterate_first) {
      ...
      if (array->iterate_remove) {
        x_container_array_remove(array, array->iterator);
        array->iterator++;
    ...
    unsigned long index, void *object)
{
  ...
  x_container_array_remove(array, index);
  x_container_array_add(array, index, object);
}
    ...
    void *object)
{
  ...
  random_index = random() % array->array_size;
  x_container_array_replace(array, random_index, object);
}
