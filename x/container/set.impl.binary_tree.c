...
static set_object_t *find_first_parent_greater_than_me(x_container_set_t *set,
    set_object_t *set_object);

static set_object_t *find_in_order_predecessor(x_container_set_t *set,
    set_object_t *set_object);

static set_object_t *find_in_order_successor(x_container_set_t *set,
    set_object_t *set_object);

static set_object_t *find_set_object_containing(x_container_set_t *set,
...
static void remove_set_object_botx_children(x_container_set_t *set,
    set_object_t *set_object);
static void remove_set_object_left_child_only(x_container_set_t *set,
    set_object_t *set_object);
static void remove_set_object_no_children(x_container_set_t *set,
    set_object_t *set_object);
static void remove_set_object_right_child_only(x_container_set_t *set,
    set_object_t *set_object);

static set_object_t *set_object_create(void *object,
    set_object_t *parent, set_object_t *left, set_object_t *right);

static void set_object_destroy(x_container_set_t *set,
    set_object_t *set_object);
...
set_object_t *find_first_parent_greater_than_me(x_container_set_t *set,
    set_object_t *set_object)
{
  assert(set);
  assert(set_object);
...
set_object_t *find_in_order_predecessor(x_container_set_t *set,
    set_object_t *set_object)
{
  assert(set_object);
...
set_object_t *find_in_order_successor(x_container_set_t *set,
    set_object_t *set_object)
{
  assert(set_object);
  set_object_t *successor;
...
set_object_t *find_set_object_containing(x_container_set_t *set,
    set_object_t *base_set_object, void *object)
{
  int compare;
...
x_core_bool_t x_container_set_add_replace(x_container_set_t *set, void *object)
{
  ...
  if (x_container_set_find(set, object)) {
    x_container_set_remove(set, object);
  }
  success = x_container_set_add(set, object);
...
x_core_bool_t x_container_set_remove(x_container_set_t *set, void *object)
{
  ...
  if (set_object) {
    _x_container_set_remove_set_object(set, set_object);
    success = x_core_bool_true;
  } else {
    success = x_core_bool_false;
  }
...
set_object_t *put_object(x_container_set_t *set, set_object_t *base_set_object,
...
void remove_set_object_botx_children(x_container_set_t *set,
    set_object_t *set_object)
{
...
void remove_set_object_left_child_only(x_container_set_t *set,
    set_object_t *set_object)
{
  if (set_object->parent) {
...
void remove_set_object_no_children(x_container_set_t *set,
    set_object_t *set_object)
{
  if (set_object->parent) {
...
void remove_set_object_right_child_only(x_container_set_t *set,
    set_object_t *set_object)
{
  if (set_object->parent) {
...
void set_object_destroy(x_container_set_t *set, set_object_t *set_object)
{
  assert(set);
  assert(set_object);
