#ifndef cf_sage_morpsage_system_h
#define cf_sage_morpsage_system_h
...
typedef struct cf_sage_morpsage_system_t cf_sage_morpsage_system_t;
 ...
 * search, call cf_sage_morpsage_system_destroy() to release resources the morph is
 * using.
 *
 * \param score_solution a function with the signature specified by
 *        cf_sage_core_score_solution_f.  this will be used to direct the morph
 ...
 *        be sent.
 *
 * \return pointer to an cf_sage_morpsage_system_t, or NULL if the call was
 *         unsuccessful.
 */
 ...
 *
 * \return an array of pointers to cf_sage_core_solution_t variables, which the
 ...
 * cf_sage_morpsage_system_create() to guide the morph.  call this method once, or
 ...
 * cf_sage_morpsage_system_search().
 *
 * \param system pointer to an inhesion::morph system
