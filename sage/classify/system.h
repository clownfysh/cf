#ifndef cf_sage_classify_system_h
#define cf_sage_classify_system_h
...
#include "cf/sage/classify/algorithm.h"

struct cf_sage_classify_system_t;
typedef struct cf_sage_classify_system_t cf_sage_classify_system_t;
 ...
 * classification system, call cf_sage_classify_system_destroy() to release
