#ifndef cf_sage_classify_algorithm_h
#define cf_sage_classify_algorithm_h
 ...
 */
enum cf_sage_classify_algorithm_t {
  CF_SAGE_CLASSIFY_ALGORITHM_ARCHETYPE,
};
typedef enum cf_sage_classify_algorithm_t cf_sage_classify_algorithm_t;
 ...
 *        one of {"archetype"}.
 * \param algorithm pointer to an cf_sage_classify_algorithm_t to set.  if this
 *        function returns cf_x_core_bool_true, the algorithm pointed to by this
 *        parameter will be set to a valid algorithm.
 *
 * \return success or failure.
 */
cf_x_core_bool_t cf_sage_classify_algorithm_get_from_string(char *string,
 ...
 */
char *cf_sage_classify_algorithm_get_string(cf_sage_classify_algorithm_t algorithm);
