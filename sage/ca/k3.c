...
cf_sage_ca_t cf_sage_ca_k3_calculate_new_cell_state(cf_sage_ca_system_t *system,
    unsigned long cell_index)
{
  ...
  context = cf_sage_ca_system_get_context(system);

  neighbor_0_index
    = cf_sage_ca_eca_get_relative_cell_index(system, cell_index, 0);
  neighbor_1_index
    = cf_sage_ca_eca_get_relative_cell_index(system, cell_index, 1);
  neighbor_2_index
    = cf_sage_ca_eca_get_relative_cell_index(system, cell_index, 2);
...
void *cf_sage_ca_k3_create_context(void *parameter_object)
{
  k3_context_t *context;
...
void cf_sage_ca_k3_destroy_context(void *context_object)
{
  free(context_object);
}

void cf_sage_ca_k3_get_cell_color(cf_sage_ca_t *cell, cf_x_core_color_t *color)
{
  cf_x_core_bit_t a;
  cf_x_core_bit_t b;
  cf_x_core_bit_t c;
...
unsigned long cf_sage_ca_k3_get_relative_cell_index(cf_sage_ca_system_t *system,
    unsigned long cell_index, unsigned long relationship)
{
  return cf_sage_ca_eca_get_relative_cell_index(system, cell_index, relationship);
}

void cf_sage_ca_k3_init_systemey(cf_sage_ca_systemey_t *systemey, void *name_object)
{
  cf_sage_ca_systemey_init(systemey, name_object,
      cf_sage_ca_k3_calculate_new_cell_state, cf_sage_ca_k3_create_context,
      cf_sage_ca_k3_destroy_context, CF_SAGE_CA_NO_END_TIME_STEP_FUNCTION,
      cf_sage_ca_k3_get_cell_color, cf_sage_ca_k3_get_relative_cell_index,
