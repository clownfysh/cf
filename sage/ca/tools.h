#ifndef cf_sage_ca_tools_h
#define cf_sage_ca_tools_h

#include "cf/x/case/array.h"
#include "cf/x/core/bitarray.h"

typedef unsigned long (*cf_sage_ca_select_initial_rule_f)();
typedef unsigned long (*cf_sage_ca_select_initial_value_f)();
