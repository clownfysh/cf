    ...
    unsigned long cell_index)
{
  ...
  neighbor_0_index = cf_sage_ca_crow_get_relative_cell_index
    (system, cell_index, 0);
  neighbor_1_index = cf_sage_ca_crow_get_relative_cell_index
    (system, cell_index, 1);
  neighbor_2_index = cf_sage_ca_crow_get_relative_cell_index
    (system, cell_index, 2);
  neighbor_3_index = cf_sage_ca_crow_get_relative_cell_index
    (system, cell_index, 3);
...
void cf_sage_ca_crow_init_systemey(cf_sage_ca_systemey_t *systemey, void *name_object)
{
  cf_sage_ca_systemey_init(systemey, name_object,
      cf_sage_ca_crow_calculate_new_cell_state, CF_SAGE_CA_NO_CREATE_CONTEXT_FUNCTION,
      CF_SAGE_CA_NO_DESTROY_CONTEXT_FUNCTION, CF_SAGE_CA_NO_END_TIME_STEP_FUNCTION,
      cf_sage_ca_system_get_cell_color_binary, cf_sage_ca_crow_get_relative_cell_index,
