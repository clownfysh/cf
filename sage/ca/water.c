#include "cf/sage/ca/water.h"
#include "cf/x/core/tools.h"

cf_sage_ca_t cf_sage_ca_water_calculate_new_cell_state(cf_sage_ca_system_t *system,
    unsigned long cell_index)
{
  ...
  cf_sage_ca_t *neighbor_3_cell;
  cf_sage_ca_t *neighbor_4_cell;
  cf_sage_ca_t *neighbor_5_cell;
  cf_sage_ca_t *neighbor_6_cell;
  cf_sage_ca_t *neighbor_7_cell;
  cf_sage_ca_t *neighbor_8_cell;
  ...
  neighbor_0_index = cf_sage_ca_water_get_relative_cell_index
    (system, cell_index, 0);
  neighbor_1_index = cf_sage_ca_water_get_relative_cell_index
    (system, cell_index, 1);
  neighbor_2_index = cf_sage_ca_water_get_relative_cell_index
    (system, cell_index, 2);
  neighbor_3_index = cf_sage_ca_water_get_relative_cell_index
    (system, cell_index, 3);
  neighbor_4_index = cf_sage_ca_water_get_relative_cell_index
    (system, cell_index, 4);
  neighbor_5_index = cf_sage_ca_water_get_relative_cell_index
    (system, cell_index, 5);
  neighbor_6_index = cf_sage_ca_water_get_relative_cell_index
    (system, cell_index, 6);
  neighbor_7_index = cf_sage_ca_water_get_relative_cell_index
    (system, cell_index, 7);
  neighbor_8_index = cf_sage_ca_water_get_relative_cell_index
    (system, cell_index, 8);

  neighbor_0_cell = cf_sage_ca_system_get_relative_cell
    (system, -2, neighbor_0_index);
  neighbor_1_cell = cf_sage_ca_system_get_relative_cell
    (system, -2, neighbor_1_index);
  neighbor_2_cell = cf_sage_ca_system_get_relative_cell
    (system, -2, neighbor_2_index);
  neighbor_3_cell = cf_sage_ca_system_get_relative_cell
    (system, -1, neighbor_3_index);
  neighbor_4_cell = cf_sage_ca_system_get_relative_cell
    (system, -1, neighbor_4_index);
  neighbor_5_cell = cf_sage_ca_system_get_relative_cell
    (system, -1, neighbor_5_index);
  neighbor_6_cell = cf_sage_ca_system_get_current_cell(system, neighbor_6_index);
  neighbor_7_cell = cf_sage_ca_system_get_current_cell(system, neighbor_7_index);
  neighbor_8_cell = cf_sage_ca_system_get_current_cell(system, neighbor_8_index);
...
unsigned long cf_sage_ca_water_get_relative_cell_index(cf_sage_ca_system_t *system,
...
void cf_sage_ca_water_init_systemey(cf_sage_ca_systemey_t *systemey, void *name_object)
{
  cf_sage_ca_systemey_init(systemey, name_object,
      cf_sage_ca_water_calculate_new_cell_state, CF_SAGE_CA_NO_CREATE_CONTEXT_FUNCTION,
      CF_SAGE_CA_NO_DESTROY_CONTEXT_FUNCTION, CF_SAGE_CA_NO_END_TIME_STEP_FUNCTION,
      cf_sage_ca_system_get_cell_color_binary,
      cf_sage_ca_water_get_relative_cell_index,
      CF_SAGE_CA_NO_START_TIME_STEP_FUNCTION);
}
