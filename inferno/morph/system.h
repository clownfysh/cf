...
(cf_inferno_core_score_solution_f score_solution, cf_inferno_core_goal_t goal,
    void *context, cf_x_case_array_t *initial_solutions, cf_x_core_log_t *log);

void cf_inferno_morpinferno_system_destroy
...
void cf_inferno_morpinferno_system_search
(cf_inferno_morpinferno_system_t *system,
