...
cf_inferno_computer_output_t *cf_inferno_computer_system_compute
(cf_inferno_computer_system_t *system, unsigned long input);

cf_inferno_computer_system_t *cf_inferno_computer_system_create
(unsigned long order, cf_inferno_computer_logic_f logic);

cf_inferno_computer_system_t *cf_inferno_computer_system_create_from_file
(char *filename);
...
cf_x_core_bool_t cf_inferno_computer_system_save_as_file
(cf_inferno_computer_system_t *system, char *filename);
