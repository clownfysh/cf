#ifndef cf_inferno_searcx_isearch_h
#define cf_inferno_searcx_isearch_h

#include "cf/inferno/core/goal.h"
#include "cf/inferno/search/tools.h"

typedef void * (*cf_inferno_searcx_isearch_create_f)
...
typedef void (*cf_inferno_searcx_isearch_destroy_f)(void *searcx_object);

typedef cf_x_case_array_t * (*cf_inferno_searcx_isearch_get_solutions_copy_f)
  (void *searcx_object, unsigned short max_solution_count);

typedef void (*cf_inferno_searcx_isearch_searcx_f)(void *searcx_object);

struct cf_inferno_searcx_isearch_t {
  cf_inferno_searcx_isearch_create_f create;
  cf_inferno_searcx_isearch_destroy_f destroy;
  cf_inferno_searcx_isearch_get_solutions_copy_f get_solutions_copy;
  cf_inferno_searcx_isearch_searcx_f search;
};
typedef struct cf_inferno_searcx_isearch_t cf_inferno_searcx_isearch_t;
