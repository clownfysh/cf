#ifndef cf_inferno_searcx_algorithm_h
#define cf_inferno_searcx_algorithm_h
 ...
 * system.
 */
enum cf_inferno_searcx_algorithm_t {
  CF_INFERNO_SEARCX_ALGORITHM_BIOS,
  CF_INFERNO_SEARCX_ALGORITHM_COR3,
  CF_INFERNO_SEARCX_ALGORITHM_EOS,
  CF_INFERNO_SEARCX_ALGORITHM_GENETIC,
};
typedef enum cf_inferno_searcx_algorithm_t cf_inferno_searcx_algorithm_t;
 ...
 * \param algorithm pointer to an cf_inferno_searcx_algorithm_t to set.  if this
