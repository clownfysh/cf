    ...
    cf_x_core_log_t *log)
{
  ...
  if (system) {
    ...
    cf_inferno_eos_actor_init_iactor(&system->iactor);
...
void cf_inferno_eos_system_init_isearch(cf_inferno_searcx_isearch_t *isearch)
{
  cf_inferno_searcx_isearch_init(isearch, cf_inferno_eos_system_create,
