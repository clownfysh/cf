    ...
    unsigned long cell_index)
{
  ...
  neighbor_0_index = cf_inferno_ca_fly_get_relative_cell_index
    (system, cell_index, 0);
  neighbor_1_index = cf_inferno_ca_fly_get_relative_cell_index
    (system, cell_index, 1);
  neighbor_2_index = cf_inferno_ca_fly_get_relative_cell_index
    (system, cell_index, 2);
  neighbor_3_index = cf_inferno_ca_fly_get_relative_cell_index
    (system, cell_index, 3);
  neighbor_4_index = cf_inferno_ca_fly_get_relative_cell_index
    (system, cell_index, 4);
  neighbor_5_index = cf_inferno_ca_fly_get_relative_cell_index
    (system, cell_index, 5);
...
void cf_inferno_ca_fly_init_systemey(cf_inferno_ca_systemey_t *systemey, void *name_object)
{
  cf_inferno_ca_systemey_init(systemey, name_object,
      cf_inferno_ca_fly_calculate_new_cell_state, CF_INFERNO_CA_NO_CREATE_CONTEXT_FUNCTION,
      CF_INFERNO_CA_NO_DESTROY_CONTEXT_FUNCTION, CF_INFERNO_CA_NO_END_TIME_STEP_FUNCTION,
      cf_inferno_ca_system_get_cell_color_binary, cf_inferno_ca_fly_get_relative_cell_index,
