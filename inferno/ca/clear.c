    ...
    unsigned long cell_index)
{
  ...
  neighbor_0_index = cf_inferno_ca_clear_get_relative_cell_index
    (system, cell_index, 0);
  neighbor_1_index = cf_inferno_ca_clear_get_relative_cell_index
    (system, cell_index, 1);
  neighbor_2_index = cf_inferno_ca_clear_get_relative_cell_index
    (system, cell_index, 2);
...
void cf_inferno_ca_clear_init_systemey(cf_inferno_ca_systemey_t *systemey, void *name_object)
{
  cf_inferno_ca_systemey_init(systemey, name_object,
      ...
      cf_inferno_ca_clear_get_relative_cell_index, cf_inferno_ca_clear_start_time_step);
}
